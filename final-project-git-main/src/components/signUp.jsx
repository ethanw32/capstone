        ...
        <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-lg">
          ...
          <form className="space-y-4">
            <div>
                ...
                <label className="block text-sm font-medium text-gray-700">Fname</label>
              <input
                type="Fname"
          ...
          <p className="text-sm text-center text-gray-500">
            If you already have a account <a href="#" className="text-blue-600 hover:underline">logIn</a>
          </p>
        </div>
      </div>
    );
